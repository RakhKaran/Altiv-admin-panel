...
import EmailTableFiltersResult from '../email-table-filters-result';
    ...
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        ...
        <Card>
          ...
          <EmailTableToolbar filters={filters} onFilters={handleFilters} />

          {canReset && (
            <EmailTableFiltersResult
              filters={filters}
            ...
            <Scrollbar>
              <Table size={table.dense ? 'small' : 'medium'} sx={{ minWidth: 960 }}>
                ...
                <TableBody>
                  ...
                  <TableEmptyRows
                    height={denseHeight}
                    emptyRows={emptyRows(table.page, table.rowsPerPage, emails.length)}
                  />
