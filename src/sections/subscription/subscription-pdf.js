      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          ...
          <View style={styles.col6}>
            ...
            <Text style={styles.body2}> Email:{subscription?.user?.email}</Text>
            <Text style={styles.body2}>Address:{subscription?.user?.fullAddress}</Text>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body2}>{fDate(subscription?.planData?.createdAt)}</Text>
          </View>
          <View style={styles.col6}>
            <Text style={[styles.subtitle2, styles.mb4]}>Due date</Text>
            <Text style={styles.body2}>{fDate(subscription?.planData?.expiryDate)}</Text>
          </View>
        </View>
